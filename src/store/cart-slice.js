...
//3- moving thunks to seperate file
...
const cartSlice = createSlice({
  ...
  initialState: {
    items: [],
    totalQuantity: 0,
    //3.2 this state is to track the changes 
    changed:false,
  },
  reducers: {
    //3.1 adding a reducer action to update the frontend cart data using the bacekend data
